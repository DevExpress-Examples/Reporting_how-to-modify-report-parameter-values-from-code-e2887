...
Namespace SilverlightReports
	Public Class MainPageViewModel
		...
		Private ReadOnly _previewModel As ReportServicePreviewModel
		Private ReadOnly _categorySubmitCommand As DevExpress.Mvvm.DelegateCommand(Of Object)
		...
		Public Sub New()
			_previewModel = New ReportServicePreviewModel() With {.ServiceUri = "../NorthwindReportService.svc", .ReportName = "Reports.ProductReport"}
