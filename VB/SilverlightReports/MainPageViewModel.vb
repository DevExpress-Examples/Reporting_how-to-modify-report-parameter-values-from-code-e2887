...
Namespace SilverlightReports
	Public Class MainPageViewModel
		...
		Private ReadOnly _categorySubmitCommand As DevExpress.Xpf.Mvvm.DelegateCommand(Of Object)
		...
		Public Sub New()
			...
			_categorySubmitCommand = New DevExpress.Xpf.Mvvm.DelegateCommand(Of Object)(AddressOf CategorySubmitted)
