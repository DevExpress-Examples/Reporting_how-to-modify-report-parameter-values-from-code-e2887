...
Namespace Reports
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class EmployeeCustomersDataTable
			...
			Default Public ReadOnly Property Item(ByVal index As Integer) As EmployeeCustomersRow
				Get
					Return (CType(Me.Rows(index), EmployeeCustomersRow))
				End Get
			End Property
			...
			Public Function AddEmployeeCustomersRow(ByVal CustomerId As String, ByVal parentEmployeesRowByEmployeesEmployeeCustomers As EmployeesRow) As EmployeeCustomersRow
				Dim rowEmployeeCustomersRow As EmployeeCustomersRow = (CType(Me.NewRow(), EmployeeCustomersRow))
			...
			Public Function FindByCustomerId(ByVal CustomerId As String) As EmployeeCustomersRow
				Return (CType(Me.Rows.Find(New Object() { CustomerId}), EmployeeCustomersRow))
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Overrides Function Clone() As Global.System.Data.DataTable
				Dim cln As EmployeeCustomersDataTable = (CType(MyBase.Clone(), EmployeeCustomersDataTable))
				cln.InitVars()
				Return cln
			End Function
			...
			Public Function NewEmployeeCustomersRow() As EmployeeCustomersRow
				Return (CType(Me.NewRow(), EmployeeCustomersRow))
			End Function
			...
			Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowChanged(e)
				If (Me.EmployeeCustomersRowChangedEvent IsNot Nothing) Then
					RaiseEvent EmployeeCustomersRowChanged(Me, New EmployeeCustomersRowChangeEvent((CType(e.Row, EmployeeCustomersRow)), e.Action))
				End If
			End Sub
			...
			Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowChanging(e)
				If (Me.EmployeeCustomersRowChangingEvent IsNot Nothing) Then
					RaiseEvent EmployeeCustomersRowChanging(Me, New EmployeeCustomersRowChangeEvent((CType(e.Row, EmployeeCustomersRow)), e.Action))
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleted(e)
				If (Me.EmployeeCustomersRowDeletedEvent IsNot Nothing) Then
					RaiseEvent EmployeeCustomersRowDeleted(Me, New EmployeeCustomersRowChangeEvent((CType(e.Row, EmployeeCustomersRow)), e.Action))
				End If
			End Sub
			...
			Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
				MyBase.OnRowDeleting(e)
				If (Me.EmployeeCustomersRowDeletingEvent IsNot Nothing) Then
					RaiseEvent EmployeeCustomersRowDeleting(Me, New EmployeeCustomersRowChangeEvent((CType(e.Row, EmployeeCustomersRow)), e.Action))
				End If
			End Sub
		...
		Partial Public Class CustomersRow
			...
			Public Property EmployeeCustomersRow() As EmployeeCustomersRow
				Get
					Return (CType(Me.GetParentRow(Me.Table.ParentRelations("EmployeeCustomersCustomers")), EmployeeCustomersRow))
				End Get
		...
		Partial Public Class EmployeeCustomersRow
			...
			Public Property EmployeeId() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableEmployeeCustomers.EmployeeIdColumn))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property EmployeesRow() As EmployeesRow
				Get
					Return (CType(Me.GetParentRow(Me.Table.ParentRelations("EmployeesEmployeeCustomers")), EmployeesRow))
				End Get
	...
	End Class
End Namespace
Namespace Reports.nwindDataSetTableAdapters
	...
	Partial Public Class EmployeeCustomersTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_CustomerId As String, ByVal Original_EmployeeId? As Integer) As Integer
			...
			If (Original_EmployeeId.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(1).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Fix(Original_EmployeeId.Value)))
			Else
		...
		Public Overridable Function Update(ByVal CustomerId As String, ByVal EmployeeId? As Integer, ByVal Original_CustomerId As String, ByVal Original_EmployeeId? As Integer) As Integer
			...
			If (Original_EmployeeId.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CInt(Fix(Original_EmployeeId.Value)))
			Else
	...
	Partial Public Class ShippersTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_ShipperID As Integer, ByVal Original_CompanyName As String, ByVal Original_Phone As String) As Integer
			Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Fix(Original_ShipperID)))
			If (Original_CompanyName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("Original_CompanyName")
			Else
				Me.Adapter.DeleteCommand.Parameters(1).Value = (CObj(0))
		...
		Public Overridable Function Update(ByVal CompanyName As String, ByVal Phone As String, ByVal Original_ShipperID As Integer, ByVal Original_CompanyName As String, ByVal Original_Phone As String) As Integer
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(Fix(Original_ShipperID)))
			If (Original_CompanyName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("Original_CompanyName")
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CObj(0))
