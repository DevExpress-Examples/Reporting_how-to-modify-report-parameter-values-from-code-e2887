...
namespace SilverlightReports {
    public class MainPageViewModel : INotifyPropertyChanged {
        ...
        readonly DevExpress.Xpf.Mvvm.DelegateCommand<object> _categorySubmitCommand;
        ...
        public MainPageViewModel() {
            ...
            _categorySubmitCommand = new DevExpress.Xpf.Mvvm.DelegateCommand<object>(CategorySubmitted);
